...
/*	public static void main(String[] args) {
	...
	public Recipe채소_과일() {
		...
		JCheckBox chckbxVyrhqjtjt = new JCheckBox("\uD45C\uACE0\uBC84\uC12F");
		panel.add(chckbxVyrhqjtjt);
		...
		JCheckBox chckbxRbf = new JCheckBox("\uD53C\uB9DD");
		panel.add(chckbxRbf);
		
		JCheckBox checkBox_23 = new JCheckBox("\uBB34\uB9D0\uB7AD\uC774");
		panel.add(checkBox_23);
		
		JCheckBox checkBox_21 = new JCheckBox("\uBBF8\uB354\uB355");
		panel.add(checkBox_21);
		
		JCheckBox checkBox_22 = new JCheckBox("\uC591\uBC30\uCD94");
		...
		JCheckBox checkBox_29 = new JCheckBox("\uC560\uD638\uBC15");
		panel.add(checkBox_29);
		
		JCheckBox checkBox_27 = new JCheckBox("\uD30C\uD504\uB9AC\uCE74");
		panel.add(checkBox_27);
		
		JCheckBox checkBox_28 = new JCheckBox("\uBC30");
		...
		JCheckBox checkBox = new JCheckBox("\uACE0\uC0AC\uB9AC");
		panel.add(checkBox);
		
		JCheckBox checkBox_20 = new JCheckBox("\uD1A0\uB9C8\uD1A0");
		panel.add(checkBox_20);
		
		JCheckBox checkBox_34 = new JCheckBox("\uC625\uC218\uC218");
		panel.add(checkBox_34);
		
		JCheckBox checkBox_35 = new JCheckBox("\uCCAD\uACBD\uCC44");
		panel.add(checkBox_35);
		
		JCheckBox checkBox_36 = new JCheckBox("\uC624\uB80C\uC9C0");
		panel.add(checkBox_36);
		
		JCheckBox checkBox_37 = new JCheckBox("\uB808\uBAAC");
		panel.add(checkBox_37);
		
		JCheckBox checkBox_38 = new JCheckBox("\uACE0\uC218");
		panel.add(checkBox_38);
		
		JCheckBox checkBox_39 = new JCheckBox("\uC0AC\uACFC");
		panel.add(checkBox_39);
		
		JCheckBox checkBox_40 = new JCheckBox("\uC0C8\uC2F9\uCC44\uC18C");
		panel.add(checkBox_40);
		
		JCheckBox checkBox_41 = new JCheckBox("\uC591\uC0C1\uCD94");
		panel.add(checkBox_41);
		
		JCheckBox checkBox_42 = new JCheckBox("\uD0C0\uC784");
		panel.add(checkBox_42);
		
		JCheckBox checkBox_43 = new JCheckBox("\uB2E8\uD638\uBC15");
